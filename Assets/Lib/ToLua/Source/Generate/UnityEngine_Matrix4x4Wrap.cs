...
public class UnityEngine_Matrix4x4Wrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("Inverse3DAffine", Inverse3DAffine);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int Inverse3DAffine(IntPtr L)
	{
		try
		{
			...
			bool o = UnityEngine.Matrix4x4.Inverse3DAffine(arg0, ref arg1);
			LuaDLL.lua_pushboolean(L, o);
	...
	static int Equals(IntPtr L)
	{
		try
		{
			...
			if (count == 2 && TypeChecker.CheckTypes<UnityEngine.Matrix4x4>(L, 2))
			{
				UnityEngine.Matrix4x4 obj = (UnityEngine.Matrix4x4)ToLua.CheckObject(L, 1, typeof(UnityEngine.Matrix4x4));
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.Matrix4x4.Equals");
			}
		}
		catch (Exception e)
		{
