...
{
    public static string luaDir = Application.dataPath + "/Lib/ToLua/LuaLogic";                //lua逻辑代码目录
    public static string toluaDir = Application.dataPath + "/Lib/ToLua/Lua";        //tolua lua文件目录
