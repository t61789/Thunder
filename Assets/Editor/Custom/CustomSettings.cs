...
{
    public static string saveDir = Application.dataPath + "/Lib/ToLua/Source/Generate/";
    public static string toluaBaseType = Application.dataPath + "/Lib/ToLua/BaseType/";
    public static string baseLuaDir = Application.dataPath + "/Lib/ToLua/Lua/";
    public static string injectionFilesPath = Application.dataPath + "/Lib/ToLua/Injection/";
