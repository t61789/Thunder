...
namespace Framework
{
    public class Package
    {
        ...
        private readonly Queue<PackageItemInfo> _PackageItemInfoQueue = new Queue<PackageItemInfo>(Config.PackageItemInfoBuffer);
        private readonly SortedDictionary<ItemId, PackageItemInfo> _PackageItemInfos = new SortedDictionary<ItemId, PackageItemInfo>();
